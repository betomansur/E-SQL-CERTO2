...
mode="dev"
model="gpt-4.1-mini"  # For GPT-4o use "gpt-4o-2024-08-06". For GPT-4o mini use "gpt-4o-mini-2024-07-18"
pipeline_order="SF-CSG-QE-SR" # First set CSG-QE-SR and then set CSG-SR, SF-CSG-QE-SR
